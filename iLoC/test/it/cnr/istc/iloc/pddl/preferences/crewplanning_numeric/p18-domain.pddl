...
(:requirements :typing :numeric-fluents :quantified-preconditions :negative-preconditions :goal-utilities)
(:types MedicalState FilterState CrewMember PayloadAct Day RPCM - object)
