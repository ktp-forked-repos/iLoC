...
:condition (and (at start (not-made p1))(at start (started o13)))
...
:parameters ()
:duration (= ?duration 30)
:condition (and (at start (not-made p3))(at start (started o7)))
...
:parameters ()
:duration (= ?duration 40)
:condition (and (at start (not-made p5))(at start (started o9)))
...
:parameters ()
:duration (= ?duration 30)
:condition (and (at start (not-made p6))(at start (started o5))(at start (started o6))(at start (started o7)))
...
:condition (and (at start (not-made p7))(at start (started o13)))
...
:parameters ()
:duration (= ?duration 60)
:condition (and (at start (not-made p8))(at start (started o1))(at start (started o3))(at start (started o5))(at start (started o12)))
...
:condition (and (at start (not-made p9))(at start (started o9))(at start (started o14)))
...
:parameters ()
:duration (= ?duration 60)
:condition (and (at start (not-made p11))(at start (started o8))(at start (started o10)))
...
:parameters ()
:duration (= ?duration 40)
:condition (and (at start (not-made p12))(at start (started o9))(at start (started o11)))
...
:condition (and (at start (not-made p13))(at start (started o15)))
...
:parameters ()
:duration (= ?duration 10)
:condition (and (at start (not-made p15))(at start (started o2))(at start (started o15)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o2))(at start (made p10))(at start (made p15))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o3))(at start (made p8))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o5))(at start (made p6))(at start (made p8))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o7))(at start (made p3))(at start (made p4))(at start (made p6))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o8))(at start (made p11))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o9))(at start (made p5))(at start (made p9))(at start (made p12))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o12))(at start (made p8))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o13))(at start (made p1))(at start (made p7))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o14))(at start (made p9))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o15))(at start (made p13))(at start (made p14))(at start (made p15))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
