...
:condition (and (at start (not-made p1))(at start (started o3))(at start (started o9)))
...
:condition (and (at start (not-made p2))(at start (started o2)))
...
:condition (and (at start (not-made p3))(at start (started o5))(at start (started o8)))
...
:parameters ()
:duration (= ?duration 40)
:condition (and (at start (not-made p5))(at start (started o6))(at start (started o7)))
...
:condition (and (at start (not-made p9))(at start (started o1))(at start (started o10)))
...
:condition (and (at start (not-made p10))(at start (started o1))(at start (started o2)))
...
:duration (= ?duration 1)
:condition (and (at start (started o1))(at start (made p6))(at start (made p9))(at start (made p10))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o2))(at start (made p2))(at start (made p10))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o3))(at start (made p1))(at start (made p7))(at start (made p8))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o5))(at start (made p3))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o6))(at start (made p5))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o8))(at start (made p3))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
