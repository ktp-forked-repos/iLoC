...
:condition (and (at start (not-made p3))(at start (started o12)))
...
:condition (and (at start (not-made p4))(at start (started o8))(at start (started o10))(at start (started o12)))
...
:parameters ()
:duration (= ?duration 30)
:condition (and (at start (not-made p5))(at start (started o4)))
...
:parameters ()
:duration (= ?duration 20)
:condition (and (at start (not-made p6))(at start (started o12)))
...
:parameters ()
:duration (= ?duration 70)
:condition (and (at start (not-made p7))(at start (started o2))(at start (started o3))(at start (started o5)))
...
:parameters ()
:duration (= ?duration 70)
:condition (and (at start (not-made p9))(at start (started o4))(at start (started o6)))
...
:condition (and (at start (not-made p10))(at start (started o1))(at start (started o9))(at start (started o11)))
...
:duration (= ?duration 1)
:condition (and (at start (started o1))(at start (made p10))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o3))(at start (made p7))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o4))(at start (made p5))(at start (made p9))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o6))(at start (made p9))(at start (made p11))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o7))(at start (made p2))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o10))(at start (made p4))(at start (made p13))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o11))(at start (made p10))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o12))(at start (made p1))(at start (made p3))(at start (made p4))(at start (made p6))(at start (made p8))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
...
:parameters (?avail ?new-avail - count)
:duration (= ?duration 1)
:condition (and (at start (started o13))(at start (made p12))(at start (stacks-avail ?avail))(at start (next-count ?avail ?new-avail)))
