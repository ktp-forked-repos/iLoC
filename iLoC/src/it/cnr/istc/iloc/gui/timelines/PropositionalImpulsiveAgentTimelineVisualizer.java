...
import it.cnr.istc.iloc.types.propositionalstate.PropositionalImpulsiveAgentType;
 ...
 */
class PropositionalImpulsiveAgentTimelineVisualizer implements ITimelineVisualizer {

    @Override
    public Class<? extends IType> getTimelineType() {
        return PropositionalImpulsiveAgentType.class;
    }
