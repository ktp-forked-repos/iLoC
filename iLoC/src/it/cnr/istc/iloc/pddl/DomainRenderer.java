 ...
 */
class DomainRenderer implements AttributeRenderer {

    private final STGroupFile file;

    DomainRenderer(STGroupFile file) {
        this.file = file;
    }

    @Override
    public String toString(Object o, String string, Locale locale) {
        ST translation = file.getInstanceOf("Domain");
        translation.add("domain", (Domain) o);
