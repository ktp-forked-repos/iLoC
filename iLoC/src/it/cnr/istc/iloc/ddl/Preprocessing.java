...
class Preprocessing extends DDLBaseListener {
    ...
    public void enterDisjunction_statement(DDLParser.Disjunction_statementContext ctx) {
        if (c_node != null) {
            ...
            solver.getStaticCausalGraph().addEdge(IStaticCausalGraph.IEdge.Type.Goal, c_node.node, node, 0);
    ...
    public void enterDisjunct(DDLParser.DisjunctContext ctx) {
        if (c_node != null) {
            ...
            if (counter.subgoals == 0) {
                ...
                solver.getStaticCausalGraph().addEdge(IStaticCausalGraph.IEdge.Type.Goal, c_node.node, no_op_node, 0);
    ...
    public void enterFormula_statement(DDLParser.Formula_statementContext ctx) {
        if (c_node != null) {
            ...
            try {
                solver.getStaticCausalGraph().addEdge(type, c_node.node, solver.getStaticCausalGraph().getNode(c_scope.getPredicate(ctx.predicate.getText())), 0);
